...
def test_filter_by_currency_missing_currency_code() -> None:
    transactions: List[Dict[str, Any]] = [
        {"id": 1, "operationAmount": {"currency": {}}},  # Добавили вложенность currency
        {"id": 2, "description": "Test", "operationAmount": {"currency": {}}},
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ([], []),
        ([{"id": 1}, {"description": None}, {"description": ""}], ["", "", ""]),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (0, 2, 3, "0000 0000 0000 0000", "0000 0000 0000 0002"),
    ],
)
